...
/**
 * Service per batch INSERT su InfluxDB.
 * Stessa architettura di BatchInsertService (code concorrenti + flush periodico)
 * ma usa WriteApiBlocking.writePoints() al posto di JdbcTemplate.batchUpdate().
 */
@Service
...
public class InfluxDBBatchInsertService implements BatchWriteService {
    ...
    public void flushAll() {
        ...
        try {
            ...
            log.info("InfluxDB batch flush completed in {} ms — inserted: telemetry={}, settings={}, statistics={}, locations={}",
    ...
    private int flushTelemetry() {
        ...
        try {
            ...
            log.error("InfluxDB batch write failed for telemetry ({} records), re-enqueuing: {}",
    ...
    private int flushSettings() {
        ...
        try {
            ...
            log.error("InfluxDB batch write failed for device_settings ({} records), re-enqueuing: {}",
                    batch.size(), ex.getMessage(), ex);
    ...
    private int flushStatistics() {
        ...
        try {
            ...
            log.error("InfluxDB batch write failed for device_statistics ({} records), re-enqueuing: {}",
                    batch.size(), ex.getMessage(), ex);
    ...
    private int flushLocations() {
        ...
        try {
            ...
            log.error("InfluxDB batch write failed for device_locations ({} records), re-enqueuing: {}",
                    batch.size(), ex.getMessage(), ex);
